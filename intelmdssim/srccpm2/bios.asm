...
;******************************************************************************
;	MODIFIED 11-JUN-2024 BY THOMAS EBERHARDT
...
SELDRVR:
	...
	JC	SETFUNC		; YES - USE 201 DRIVER
	RAR			; TEST IF 206 SELECTED
	JC	SETFUNC6	; YES - USE 206 DRIVER
	JMP	SETFUNC2	; IF NONE OF THE ABOVE - USE 202 DRIVER
...
;	SET FUNCTION FOR NEXT I/O (COMMAND IN REG-C)
	...
	MOV	M,A		;	*
	INX	H		; MOVE TO IO FUNCTION ADDRESS
...
;	SET FUNCTION FOR NEXT I/O (COMMAND IN REG-C)
	...
	LXI	H,IOPB		; IO PARAMETER BLOCK ADDRESS
	MVI	A,80H		; INITIALIZE IOPB FOR SINGLE DENSITY 201
	MOV	M,A		;	*
...
;	SET FUNCTION FOR NEXT I/O (COMMAND IN REG-C)
	LXI	H,IOPB		; IO PARAMETER BLOCK ADDRESS
	MVI	A,80H		; INITIALIZE IOPB FOR HARD DISK 206
	MOV	M,A		;	*
	INX	H		; MOVE TO IO FUNCTION
	MOV	A,M		; GET IT TO ACCUMULATOR FOR MASKING
	ANI	1111$0000B	; REMOVE PREVIOUS COMMAND
...
MAP6D:	MOV	M,A		; IOPB SECTOR NUMBER = A
	...
	DCX	H
	MOV	M,C		; SAVE IO FUNCTION IN IOPB
